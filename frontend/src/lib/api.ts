...
export const manufacturingApi = {
  ...
  createBom: (data: Record<string, unknown>) => api.post("/manufacturing/boms", data),
  updateBom: (id: string, data: Record<string, unknown>) => api.put(`/manufacturing/boms/${id}`, data),
  deleteBom: (id: string) => api.delete(`/manufacturing/boms/${id}`),
  toggleBomStatus: (id: string, isActive: boolean) => api.patch(`/manufacturing/boms/${id}/status`, { isActive }),
  cloneBom: (id: string) => api.post(`/manufacturing/boms/${id}/clone`),
  getBomImpact: (id: string, qty: number) => api.get(`/manufacturing/boms/${id}/impact?qty=${qty}`),
